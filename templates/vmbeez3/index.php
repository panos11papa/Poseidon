...
// Param 2 Variable
$change_content_width = $this->params->get('change_content_width');
$content_width = $this->params->get('content_width');
// Output as HTML5
$this->setHtml5(true);
...
<html lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>">
	...
	<body id="shadow">
		<div id="all" <?php if ($this->params->get('change_content_width')) {
			...
			<div id="back">
				<header id="header">
					...
					<div id="line">
						<?php if ($this->params->get('fontsizeselect')) { ?>
						<div id="fontsize"></div>
						<?php } ?>
					...
					<?php } ?>
					<?php /*if ($this->params->get('main_menu_position') == 'main_menu_top') { ?>
				...
				<div id="<?php echo $showRightColumn ? 'contentarea2' : 'contentarea'; ?>">
					...
					<?php
					$r = $this->params->get('nav2cont_ratio','25');
